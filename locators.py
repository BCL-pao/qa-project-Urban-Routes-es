...
# Localizador de navegacion y configuracion inicial del taxi
...
# Localizador trajeta de credito y codigo
...
# Localizador opciones adicionales en requerimientos
...
# Localizador ventana de confirmacion
order_wait_screen = (
...
#  La espera explícita de Selenium para que los campos estén presentes, se pueda hacer clic o sean visibles
